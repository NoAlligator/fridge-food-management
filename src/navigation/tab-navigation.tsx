...
export default function Tabs() {
  // const FreshLayer = useCallback(() => <LayerScreen layer={'Fresh'} />, []);
  // const FrozenLayer = useCallback(() => <LayerScreen layer={'Frozen'} />, []);
  // const NormalLayer = useCallback(() => <LayerScreen layer={'Normal'} />, []);
